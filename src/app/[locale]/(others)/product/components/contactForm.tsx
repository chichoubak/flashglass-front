...
interface ContactFormWithProductProps {
    productId: string
}

export default function ContactFormWithProduct({ productId }: ContactFormWithProductProps) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault()
        console.log(formData) // Affiche les données avec le Product ID
    ...
    return (
        <div className="w-[95%] sm:w-[80%] lg:w-[90%] mx-auto max-w-[900px] my-5 p-6 rounded-[1.5rem] lg:rounded-[2rem] bg-white border shadow-lg">
