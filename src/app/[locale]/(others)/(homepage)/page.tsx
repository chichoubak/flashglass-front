import { fetchFaqs, fetchProducts, fetchProjects } from '@/api/bo/collection'
...
export default async function Home({ params }: { params: Promise<{ locale: string }> }) {
	...
	const [products, faqData, projects] = await Promise.all([getHomepageContent(locale), fetchFaqs(fetch, { locale, fields: '*' }), getProjects(locale)])
